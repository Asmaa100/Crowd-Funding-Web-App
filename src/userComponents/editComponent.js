...
function EditProfile({ setEdited }) {
  ...
  const usernameRegExp = /^[a-zA-Z0-9]([._-](?![._-])|[a-zA-Z0-9]){0,18}[a-zA-Z0-9]$/;
  const fbRegExp =
      ...
      {isLoading ? (
        ...
        <Formik
          ...
          validationSchema={Yup.object().shape({
            ...
            first_name: Yup.string().min(3, 'Name must be at least 3 characters'),

            last_name: Yup.string().min(3, 'Name must be at least 3 characters'),
            ...
            country: Yup.string().min(2, 'Not a valid Country'),
            fb_profile: Yup.string().matches(fbRegExp, 'Not valid URL'),
            country: Yup.string().matches(countryRegExp, 'This not a country'),
          })}
          render={(
              ...
              <div className='card cascading-right shadow-lg rounded'>
                <div className='card-body p-5 text-center'>
                  <h2
                    ...
                    style={{ color: '#354f6f', textShadow: '3px 3px 3px #e9ece' }}>
                    Edit Profile
                  </h2>
                  <Form onSubmit={handleSubmit}>
                    ...
                    <div className='row mb-1'>
                      <div className='form-group mx-auto my-1 d-inline-block col'>
                        ...
                        <Field
                          ...
                          className={
                            'form-control' +
                            (errors.mobile_phone && touched.mobile_phone ? ' is-invalid' : '')
                          }
                          onKeyUp={handleChange}
                        />
                        <ErrorMessage
                    ...
                    <div className='row mb-1'>
                      ...
                      <div className='form-outline mx-auto w-100'>
                        <label className='form-label' htmlFor='fb_profile'>
                          Facebook Profile
                        </label>
                        <Field
                          name='fb_profile'
                          ...
                          className={
                            'form-control' +
                            (errors.fb_profile && touched.fb_profile ? ' is-invalid' : '')
                          }
                          onKeyUp={handleChange}
                        />
                        <ErrorMessage
