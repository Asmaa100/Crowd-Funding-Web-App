    ...
    <div className='container-fluid footer text-secondary shadow'>
      <div className='d-flex flex-wrap justify-content-between align-items-center mx-4 '>
        <div>
          ...
          <p>
            <i className='fa-solid fa-envelope px-2'></i>AteamE2E@gmail.com
          </p>
        </div>
        <button className='btn  border border-dark px-4 ms-4 h-25'>Contact Us</button>
        <div>
          <div className='m-1'>
          ...
          <p>Copyright &copy; 2022 A-web team</p>
        </div>
      </div>
    </div>
  );
